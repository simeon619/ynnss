			...
			<SheetContent className="flex flex-col w-full sm:max-w-lg">
				...
				{items.length === 0 ? (
					<div className="flex-1 flex flex-col items-center justify-center gap-4 py-12">
						<div className="flex h-20 w-20 items-center justify-center border-4 border-black bg-white">
							<ShoppingBag className="h-10 w-10" />
						</div>
						<div className="text-center">
							<p className="text-lg font-black uppercase">Your cart is empty</p>
							<p className="text-sm font-bold mt-1">Add some products to get started</p>
						</div>
						<Button
							variant="outline"
							className="rounded-none border-2 border-black uppercase font-black hover:bg-black hover:text-white"
							onClick={closeCart}
						>
							Continue Shopping
						</Button>
